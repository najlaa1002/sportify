...
<body>
    ...
    <main>
                <div class="container-fluid">
                    ...
                    <form method="POST" action="rdv_client.php" class="container d-flex flex-column align-items-center">
...
if (!$db_handle){
  die("Connexion échouée". mysqli_connect_error());
     ...
     $sql = "SELECT  Nom_client, Prénom_client, Email_client, N_Carte_etudiante,Id_Rdv, Date, Heure, Lieu,Document_demandé,Digicode,Montant
             FROM client JOIN rdv ON client.Id_client= rdv.Id_Rdv
            		...
            		if ($username2 !="" || $motdepasse != "") { 
            		 $result = mysqli_query($db_handle, $sql);
            		  ...
            		  if (!$result) {
                       ...
                       echo " Document demandé: " . $data["Document_demandé"] . "<br>";
                       echo "<br>";

                       echo " Digicode: " . $data["Digicode"]."<br>" ;
                       echo "<br>";
                
                       echo "Montant: " . $data["Montant"]."<br>" ;
                       echo "<br>";
