            ...
            <main>
                <div id="creationcompte">
                    ...
                    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                        ...
                        <label for="telephone">Bureau :</label>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if (
                         ...
                         isset($_POST["telephone"]) && isset($_POST["bureau"]) && isset($_POST["mdp"])
                        ) {
                            ...
                            $requete = "SELECT * FROM $table WHERE Nom_coach = '$nom' AND Prénom_coach = '$prenom' AND Email_coach = '$email'";
                            ...
                            // Préparer la requête d'insertion des données
                                $sql = "INSERT INTO $table (Nom_coach, Prénom_coach, Email_coach, Bureau_coach,Téléphone_coach, Mdp_coach) VALUES ('$nom', '$prenom','$bureau', '$email', '$telephone','$mdp')";

                                 if ($conn->query($sql) === TRUE) {
                                echo "Le nouveau coach a été ajouté avec succès.";
                                 } else {
                                echo "Erreur lors de l'ajout du coach : " . $conn->error;
                                 }
                            }
